...
const aiUniverseData = async () => {
    ...
    try {
        ...
        console.log('Error could happen:' + error);
    }
}
...
// Data pass to the Frontend;
    ...
    data.forEach(aiHub => {
        ...
        // Create div for inserting element to divContainer;
        ...
        div.innerHTML = `
                <div class="card p-3 mainCard">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <button onclick="CardDetails('${id}')" id="radius" class="right-arrow" data-bs-toggle="modal" data-bs-target="#exampleModal"><span><img src="../images/right-arrow.png" /></span></button>
                        </div>
                    </div>
                </div>
        `
        // Inserted to divContainer

        divContainer.appendChild(div);

        // Spinner stop loading after the Data successfully;
        isLoading(false);
    })
}
...
// Showing the data to the Modal;
        ...
        document.getElementById('right-div').innerHTML = `
         <img src="${image_link[0] ? image_link[0] : 'Image not found'}" class="card-img-top rounded" alt="...">
         <div class="accuracy">
...
// Sort by Date;
        ...
        try {
            ...
            // seeMore btn Enable & Disable functionality;
            const seeMoreBtn = document.getElementById('seeMoreBtn');
